...
ekrangenis=pencere.winfo_screenwidth()//2-160 #ekrangenisten 320'nin yarısını çıkarttım.
ekranyuksek=pencere.winfo_screenheight()//2-150 #ekranyüksekten 300'ün yarısını çıkarrtım.
pencere.geometry("320x300+{}+{}".format(ekrangenis, ekranyuksek))
#her pc de ekran boyutu farklı olduğu icin 2'ye bolup yarısını cıkarttım.
